            ...
            <form action="{{ route('resetPassword') }}" method="POST" class="member-profile form-underline"
                ...
                <div class="field-inline align-items-center">
                    <div class="field-input-number">
                        <label for="phone_number">Enter Your Phone Number <span style="color:red">*</span></label>
                ...
                <div class="field-input">
                    <label for="phone_number"> OTP <span style="color:red">*</span></label>
                    <input type="tel" id="RverificationCode" placeholder=" Enter your OTP " value=""
                ...
                <div class="field-input">
                    <label for="new_password_confirmation">Re-enter new password <span
