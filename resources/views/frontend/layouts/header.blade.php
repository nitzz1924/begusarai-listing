                                    ...
                                    <ul class="menu-arrow">
                                        <li>
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li>
                                                    <a href="city-details-1.html" title="Barcelona">Barcelona</a>
                                                </li>
                                                <li>
                                                    <a href="city-details-1.html" title="Amsterdam">Amsterdam</a>
                                                </li>
                                                <li>
              ...
              title="Health Medical">Health Medical</a>
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li>
                                                    ...
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li>
                                                            <a href="single-3.html" title="Restaurant">Restaurant
                                                                Type</a>
                                                        </li>
                                                    </ul>
                                                </li>
                    ...
                    <div class="site__brand">
                        <a title="Logo" href="/" class="site__brand__logo"><img
                                src="{{ asset('assets/images/begusarai-logo.png') }}" alt="Golo" /></a>
                    </div>
                    <!-- .site__brand -->
                </div>
                <!-- .site -->
                        ...
                        <ul>
                            ...
                            <li>
                                @auth
                                    ...
                                    <p>Email: {{ Auth::user()->phoneNumber }}</p>
                                    <!-- Other user data -->
                                @else
          ...
          <a title="App Landing" href="app-landing.html">App Landing</a>
                    ...
                    <div class="popup popup-form">
                        ...
                        <div class="popup-content">
                            ...
                            <form action="{{ route('user.auth.loginUser') }}" method="POST"
                                class="form-log form-content" id="login">
                                @csrf <!-- Add the CSRF token for security -->
                                <div class="field-input">
                                    <input type="number" placeholder="Phone mobileNumber" value=""
