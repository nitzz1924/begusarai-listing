                        ...
                        <div class="col-lg-6">
                            <div class="ob-item">
                                ...
                                <div class="ob-head">
                                    ...
                                    <a href="{{ route('ownerLeads', ['id' => $businesses[0]->id]) }}" class="view-all"
                                ...
                                <div class="ob-content">
                                    <ul>
                                        ...
                                        <li class="pending">
                                            ...
                                            <p class="status"><b>Status:</b><span style="color:green">Approved</span>
                                            </p>
                        ...
                        <div class="col-lg-6">
                            <div class="ob-item">
                                <div class="ob-head">
                                    ...
                                    @if (count($businesses) > 0)
                                    <a href="{{ route('ownerListing', ['id' => $businesses[0]->id]) }}" class="view-all"
                                        title="View All">View all</a>
                                    @endif
                                </div>
                                <div class="ob-content">
                                                ...
                                                <div class="place__author__info">
                                                    ...
                                                    <div class="place__author__star">
                                                        @for ($i = 0; $i < $review['rating']; $i++) <i
                                                            class="la la-star filled-star"></i>
                                                            <!-- Add a class for filled stars -->
                                                            @endfor
                                                            <span style="width: 72%">
                                                                @for ($i = 0; $i < 5 - $review['rating']; $i++) <i
                                                                    class="la la-star"></i>
                                                                    @endfor
                                                            </span>
                                                    </div>
