                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select id="duration" name="duration"
                            class="form-control custom-select @error('duration') is-invalid @enderror" required>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select id="noOfPlace" name="noOfPlace" class="form-control" required>
                            <option value="{{ old('noOfPlace', $package->noOfPlace) }}">
                                {{ old('noOfPlace', $package->noOfPlace) }} </option> <!-- Default placeholder -->
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" id="featuredListings" name="featuredListings"
                            class="form-control @error('featuredListings') is-invalid @enderror"
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select id="featuredType" name="featuredType"
                            class="form-control @error('featuredType') is-invalid @enderror" required>
