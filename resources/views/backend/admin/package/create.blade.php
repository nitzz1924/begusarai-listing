        ...
        <form id="create" action="{{ route('admin.package.store') }}" enctype="multipart/form-data" method="post"
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" id="off" name="off" class="form-control" value="{{ old('off') }}" required>
                    @error('off')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group col-md-6">
                    ...
                    <input type="text" id="noOfPlace" name="noOfPlace" class="form-control" value="{{ old('noOfPlace') }}" required>
                    @error('noOfPlace')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group col-md-6">
                    ...
                    <input type="text" id="featuredListings" name="featuredListings" class="form-control" value="{{ old('featuredListings') }}" required>
                ...
                <div class="form-group col-md-6">
                    ...
                    <option value="" selected>Select</option>
                        <option value="home_featured" {{ old('featuredType') == 'home_featured' ? 'selected' : '' }}>Home Featured</option>
                        <option value="city_listing" {{ old('featuredType') == 'city_listing' ? 'selected' : '' }}>City Listing</option>
                        <option value="category_listing" {{ old('featuredType') == 'category_listing' ? 'selected' : '' }}>Category Listing</option>
                    </select>
                    @error('featuredType')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
